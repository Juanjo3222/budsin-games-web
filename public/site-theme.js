(function () {
  ...
  var THEMES = {
    ...
    steam: {
      "--bg": "#1b2838",
      "--bg-2": "#172130",
      "--surface": "rgba(27, 40, 56, 0.88)",
      "--surface-strong": "rgba(23, 33, 45, 0.96)",
      "--panel": "rgba(27, 40, 56, 0.92)",
      "--line": "rgba(102, 192, 244, 0.15)",
      "--text": "#c6d4df",
      "--muted": "#8091a7",
      "--red": "#cd4a4a",
      "--blue": "#66c0f4",
  ...
  function ensureStyle() {
    ...
    style.textContent = [
      ...
      "html[data-site-theme='steam'] { color-scheme: dark; }",
      ...
      "}",
      "html[data-site-theme='steam'] body.budsin-theme-surface {",
      "  background: radial-gradient(circle at top left, rgba(102, 192, 244, 0.08), transparent 24%), radial-gradient(circle at bottom right, rgba(164, 208, 7, 0.05), transparent 28%), linear-gradient(180deg, #171a21 0%, var(--bg, #1b2838) 48%, var(--bg-2, #172130) 100%) !important;",
      "}",
      ...
      "html[data-site-theme='steam'] body.budsin-game-only { background-color: #1b2838 !important; color: #c6d4df !important; }",
      ...
      "html[data-site-theme='steam'] #message { background: rgba(27, 40, 56, 0.96) !important; color: #c6d4df !important; border: 1px solid rgba(102, 192, 244, 0.15); border-radius: 28px; box-shadow: 0 24px 64px rgba(0, 0, 0, 0.5) !important; }",
      ...
      "html[data-site-theme='steam'] #message h1, html[data-site-theme='steam'] #message h2, html[data-site-theme='steam'] #message h3, html[data-site-theme='steam'] #message p, html[data-site-theme='steam'] #message code { color: #c6d4df !important; }",
      ...
      "html[data-site-theme='steam'] #message a { background: linear-gradient(135deg, #66c0f4, #1999ff) !important; color: #1b2838 !important; border-radius: 18px; text-transform: none; font-weight: 800; }",
      ...
      "html[data-site-theme='steam'] #launch_countdown_screen { background: linear-gradient(180deg, rgba(27, 40, 56, 0.98), rgba(23, 33, 45, 0.98)) !important; color: #c6d4df !important; }",
      "html[data-site-theme='light'] #launch_countdown_screen > div, html[data-site-theme='dark'] #launch_countdown_screen > div, html[data-site-theme='ps5'] #launch_countdown_screen > div, html[data-site-theme='steam'] #launch_countdown_screen > div { padding: 24px 28px; border-radius: 28px; max-width: min(92vw, 720px); }",
      ...
      "html[data-site-theme='steam'] #launch_countdown_screen > div { background: rgba(27, 40, 56, 0.92); box-shadow: 0 24px 64px rgba(0, 0, 0, 0.5); }",
      ...
      "html[data-site-theme='steam'] #launch_countdown_screen h1, html[data-site-theme='steam'] #launch_countdown_screen h2 { color: #c6d4df !important; }",
      ...
      "html[data-site-theme='steam'] #skipCountdown { background: linear-gradient(135deg, #66c0f4, #1999ff); color: #1b2838; border: 0; border-radius: 16px; min-height: 46px; padding: 0 18px; font: inherit; font-weight: 800; cursor: pointer; }",
      ...
      "html[data-site-theme='steam'] #topBar { background: rgba(27, 40, 56, 0.82) !important; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.35); }",
      ...
      "html[data-site-theme='steam'] #topBar a, html[data-site-theme='steam'] #topBar div { color: #c6d4df !important; }",
      ...
      "html[data-site-theme='steam'] .topbar, html[data-site-theme='steam'] .frame-shell, html[data-site-theme='steam'] #unity-container, html[data-site-theme='steam'] #c2canvasdiv, html[data-site-theme='steam'] .note, html[data-site-theme='steam'] #loading-panel { border-color: rgba(102, 192, 244, 0.2) !important; }",
      ...
      "html[data-site-theme='steam'] .note { background: rgba(27, 40, 56, 0.92) !important; color: #8091a7 !important; border-color: rgba(102, 192, 244, 0.2) !important; box-shadow: 0 16px 36px rgba(0, 0, 0, 0.4) !important; }",
      ...
      "html[data-site-theme='steam'] #loading-panel { background: rgba(27, 40, 56, 0.92) !important; color: #c6d4df !important; border-color: rgba(102, 192, 244, 0.2) !important; box-shadow: 0 16px 36px rgba(0, 0, 0, 0.4) !important; }",
      ...
      "html[data-site-theme='steam'] .topbar { background: linear-gradient(140deg, rgba(27, 40, 56, 0.96), rgba(23, 33, 45, 0.9)), linear-gradient(120deg, rgba(102, 192, 244, 0.1), rgba(25, 153, 255, 0.06)) !important; box-shadow: 0 24px 64px rgba(0, 0, 0, 0.45) !important; }",
      ...
      "html[data-site-theme='steam'] .back, html[data-site-theme='steam'] .btn-primary, html[data-site-theme='steam'] .player-overlay__start { background: linear-gradient(135deg, #66c0f4, #1999ff) !important; color: #1b2838 !important; box-shadow: 0 18px 34px rgba(25, 153, 255, 0.35) !important; }",
      ...
      "html[data-site-theme='steam'] .btn-alt { background: linear-gradient(135deg, #1b2838, #243447) !important; color: #c6d4df !important; box-shadow: 0 16px 36px rgba(0, 0, 0, 0.4) !important; }",
      ...
      "html[data-site-theme='steam'] .shell > .title { background: linear-gradient(140deg, rgba(27, 40, 56, 0.96), rgba(23, 33, 45, 0.92)), linear-gradient(135deg, rgba(102, 192, 244, 0.08), rgba(25, 153, 255, 0.06)) !important; border-color: rgba(102, 192, 244, 0.18) !important; box-shadow: 0 24px 64px rgba(0, 0, 0, 0.5) !important; }",
      ...
      "html[data-site-theme='steam'] .title, html[data-site-theme='steam'] .title strong, html[data-site-theme='steam'] .title-copy h1 { color: #c6d4df !important; }",
      ...
      "html[data-site-theme='steam'] .title span, html[data-site-theme='steam'] .title-copy p, html[data-site-theme='steam'] .note, html[data-site-theme='steam'] #loading-panel { color: #8091a7 !important; }",
      ...
      "html[data-site-theme='steam'] .shell > .title::before, html[data-site-theme='steam'] .topbar .title::before { background: rgba(102, 192, 244, 0.12) !important; color: #66c0f4 !important; }",
      ...
      "html[data-site-theme='steam'] .shell > .title::after { background: radial-gradient(circle at 30% 30%, rgba(102, 192, 244, 0.1), transparent 52%), radial-gradient(circle at 70% 70%, rgba(164, 208, 7, 0.08), transparent 46%) !important; opacity: 0.65 !important; }",
      ...
      "html[data-site-theme='steam'] .hero-badges span { background: rgba(102, 192, 244, 0.1) !important; border-color: rgba(102, 192, 244, 0.16) !important; color: #c6d4df !important; }",
      ...
      "html[data-site-theme='steam'] .library { background: rgba(27, 40, 56, 0.84) !important; border-color: rgba(102, 192, 244, 0.14) !important; box-shadow: 0 24px 64px rgba(0, 0, 0, 0.45) !important; }",
      ...
      "html[data-site-theme='steam'] .library-head p, html[data-site-theme='steam'] .content p, html[data-site-theme='steam'] .changelog-card p { color: #8091a7 !important; }",
      ...
      "html[data-site-theme='steam'] .library-kicker, html[data-site-theme='steam'] .changelog-card span { background: rgba(102, 192, 244, 0.14) !important; color: #66c0f4 !important; }",
      ...
      "html[data-site-theme='steam'] .library-meta { background: linear-gradient(135deg, rgba(23, 33, 45, 0.96), rgba(27, 40, 56, 0.9)) !important; color: rgba(198, 212, 223, 0.8) !important; }",
      ...
      "html[data-site-theme='steam'] .games .game-card { background: rgba(23, 33, 45, 0.92) !important; border-color: rgba(102, 192, 244, 0.12) !important; color: #c6d4df !important; }",
      ...
      "html[data-site-theme='steam'] .budsin-fullscreen-button { background: linear-gradient(135deg, #66c0f4, #1999ff); color: #1b2838; box-shadow: 0 16px 36px rgba(0, 0, 0, 0.4); }",
      ...
      "html[data-site-theme='steam'] #" + BUTTON_ID + " { background: linear-gradient(135deg, #66c0f4, #1999ff); color: #1b2838; }",
  ...
  function setThemeVariables(theme) {
    ...
    root.style.colorScheme = (theme === "ps5" || theme === "steam") ? "dark" : theme;
  }
  ...
  function updateButton(theme) {
    ...
    var nextTheme = (theme === "dark" || theme === "ps5" || theme === "steam") ? "light" : "dark";
  ...
  function ensureButton() {
    ...
    button.addEventListener("click", function () {
      ...
      var next = (current === "dark" || current === "ps5" || current === "steam") ? "light" : "dark";
      applyTheme(next);
    });
    document.body.appendChild(button);
  }
